...
ggplot(dat4c, aes(x= income, fill = education)) + geom_bar() + xlab("Income") + ylab("Count") + ggtitle("Relationship between Education Level and Income") + scale_fill_discrete(name = "Education Level")
    ...
    ```
   Based on the output I think it is safe to say that most respondents have an income of $25,000 or more. The education level of those respondents seem to mostly be around 11-15 so about right in the middle of the education level.  
